...
void _Function_1()
{
    ...
    if (1)
    {
        ...
        _gfn_status = clSetKernelArg(_kernel, 1, sizeof(cl_mem), (void *) &_cl_mem_s1);
        _GfnCheckCLStatus(_gfn_status, "SET KERNEL ARG 1");
        _gfn_status = clSetKernelArg(_kernel, 2, sizeof(int) * _work_group_item_num, 0);
        _GfnCheckCLStatus(_gfn_status, "SET KERNEL ARG (LOCAL SIZE)");
        _gfn_status = clSetKernelArg(_kernel, 3, sizeof(cl_mem), (void *) &_cl_mem_s2);
        _GfnCheckCLStatus(_gfn_status, "SET KERNEL ARG 3");
        _gfn_status = clSetKernelArg(_kernel, 4, sizeof(float) * _work_group_item_num, 0);
        _GfnCheckCLStatus(_gfn_status, "SET KERNEL ARG (LOCAL SIZE)");
        _gfn_status = clSetKernelArg(_kernel, 5, sizeof(int), (void *) &_local_i_start);
        _GfnCheckCLStatus(_gfn_status, "SET KERNEL ARG 5");
        _gfn_status = clSetKernelArg(_kernel, 6, sizeof(int), (void *) &_local_i_end);
        _GfnCheckCLStatus(_gfn_status, "SET KERNEL ARG 6");
        _gfn_status = clSetKernelArg(_kernel, 7, sizeof(int), (void *) &_loop_step);
        _GfnCheckCLStatus(_gfn_status, "SET KERNEL ARG 7");

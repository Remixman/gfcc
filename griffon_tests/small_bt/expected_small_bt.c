...
void _InitOpenCL();
void _FinalOpenCL();
cl_kernel _GfnCreateKernel(const char *name, const char *src, cl_context context, cl_device_id device_id);
...
/*             k++) */
/*         { */
/*             us[((i) * isize * jsize) + ((j) * isize) + (k)] = i + j + k; */
/*         } */
/*     } */
/* }\n */
/* }\n */
            ...
            j++)
        {
                ...
                k++)
            {
                ...
                if (diff > 0.0001 || - 0.0001 < diff)
                {
                    ...
                    ((0) ? (void) (0) : __assert_fail("0", "small_bt.c", 75, __PRETTY_FUNCTION__));
                }
            }
        }
    }

...
void _Function_1()
{
    ...
    _GfnEnqueueBroadcastND((void *) B[0], _cl_mem_B, _GFN_TYPE_FLOAT(), 1, 1, 2, n, n);
    ...
    if (1)
    {
        ...
        _GfnSetKernelArg(_kernel, 1, sizeof(cl_mem), (void *) &_cl_mem_C);
        _GfnSetKernelArg(_kernel, 2, sizeof(cl_mem), (void *) &_cl_mem_A);
        _GfnSetKernelArg(_kernel, 3, sizeof(cl_mem), (void *) &_cl_mem_B);
        _GfnSetKernelArg(_kernel, 4, sizeof(int), (void *) &_local_i_start);
        _GfnSetKernelArg(_kernel, 5, sizeof(int), (void *) &_local_i_end);

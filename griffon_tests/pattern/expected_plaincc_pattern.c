...
void _CalcPartitionInfo(int size, int block_size, int *pattern_array, int pattern_type, int *cnts, int *disp, int *sub_size, int *elem_offset);
int _GFN_TYPE_CHAR();
...
void _Function_1()
{
    ...
    _GfnEnqueueScatter1D((void **) &B, _cl_mem_B, _GFN_TYPE_INT(), 1, 300, _GFN_MEM_READ_ONLY(), 0, 0, 1, 1);
    ...
    /* Gather Array Memory */
    _GfnEnqueueGather1D((void **) &A, _cl_mem_A, _GFN_TYPE_INT(), 1, 300, _GFN_MEM_WRITE_ONLY(), 0, 0, 1, 1);

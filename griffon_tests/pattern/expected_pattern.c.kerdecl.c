...
void _Function_1()
{
    ...
    _GfnEnqueueScatterND((void *) B, _cl_mem_B, _GFN_TYPE_INT(), _GFN_MEM_READ_ONLY(), 1, (299) - 1, 1, 0, 1, 1, 1, 1, 2, 300, - 1, 1);
    ...
    /* Gather Array Memory */
    _GfnEnqueueGatherND((void *) A, _cl_mem_A, _GFN_TYPE_INT(), _GFN_MEM_WRITE_ONLY(), 1, (299) - 1, 1, 0, 0, 1, 1, 1, 0, 300);
